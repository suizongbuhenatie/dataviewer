...
class Container(Component):
    ...
    def __init__(self, id: Optional[str] = None, padding: str = "0", margin: str = "0", **kwargs):
...
class FlexRow(Container):
    ...
    def __init__(self, justify: str = "start", align: str = "start", wrap: bool = False, id: Optional[str] = None, padding: str = "0", margin: str = "0", **kwargs):
...
class FlexColumn(Container):
    ...
    def __init__(self, justify: str = "start", align: str = "start", id: Optional[str] = None, padding: str = "0", margin: str = "0", **kwargs):
        self.justify = justify
        self.align = align
        super().__init__(id=id, padding=padding, margin=margin, **kwargs)
...
class Grid(Container):
    ...
    def __init__(self, cols: int = 2, rows: Optional[int] = None, gap: str = "4", id: Optional[str] = None, padding: str = "0", margin: str = "0", **kwargs):
        self.cols = cols
        self.rows = rows
        self.gap = gap
        super().__init__(id=id, padding=padding, margin=margin, **kwargs)
