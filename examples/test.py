...
CellRendererRegistry.register(
    CellImageRenderer(
        patterns=[".png", ".jpg"],  # 使用文件扩展名作为匹配模式
...
data = [
    {
        ...
        "image": ["examples/example.png", "examples/example.png", "examples/example.png", "examples/example.png", "examples/example.png", "examples/example.png", "examples/example.png", "examples/example.png", "examples/example.png", "examples/example.png"],
